...
let everything = galleryCharacters.concat(galleryHeads, galleryBody, galleryProps, galleryJets, galleryTanks, galleryArtillery, galleryDronesMilitary, galleryMilitaryMales, galleryDesks, galleryPeople, galleryTables);
