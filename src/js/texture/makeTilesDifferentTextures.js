// makeTilesDifferentTextures.js

// make Tiles by specifying the amount of rows and columns for a Background
function makeTilesDifferentTextures(whichArray, whichFolder, whichSubFolder, whichTexture, rows, columns, xPos, yPos, sizeX, sizeY)
{
    let tileCounter = 0;
    ...
    for (let j = 0; j < rows; j++)
    {
        ...
        for (let x = 0; x < columns; x++)
        {
            ...
            let makeTile = ce("img");
            makeTile.src = thePath + whichArray[x];
